...
class Oceania extends StatefulWidget {
  ...
  @override
  State<Oceania> createState() => _OceaniaState();
}

class _OceaniaState extends State<Oceania> {
  @override
              ...
              Container(
                decoration: const BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage('assets/images/back_oceania.jpg'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
      ...
      body: FutureBuilder<List<Country>>(
        ...
        builder: (context, snapshot) {
          ...
          final countries = snapshot.data!
              .where((c) => (c.subregion).contains('Australia'))
              .toList();
